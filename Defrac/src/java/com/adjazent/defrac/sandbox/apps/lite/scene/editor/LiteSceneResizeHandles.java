 ...
 * @version 0.1
 */
public final class LiteSceneResizeHandles
{
	...
	public LiteSceneResizeHandles( Layer container )
	{
	...
	public void setPosition( LiteSceneItemView element )
	{
		float s = size * 0.5f;
