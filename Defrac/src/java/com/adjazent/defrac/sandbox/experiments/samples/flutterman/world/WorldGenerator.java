package com.adjazent.defrac.sandbox.experiments.samples.flutterman.world;

import com.adjazent.defrac.sandbox.experiments.samples.flutterman.visual.TileSlice;
...
public final class WorldGenerator
{
	...
	public void generate( @Nonnull final TileSlice slice )
	{
		...
		{
			case 0:
				tiles[ 0 ] = Sprites.BOX_0;
				break;
			case 1:
				tiles[ 0 ] = Sprites.BOX_1;
				break;
			case 2:
				tiles[ 0 ] = Sprites.BOX_2;
				break;
			case 3:
				tiles[ 0 ] = Sprites.BOX_3;
				break;
		}
