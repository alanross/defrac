package com.adjazent.defrac.sandbox.experiments.samples.canvas;
...
public class GLUtil
{
	public static GLShader createShader( GL gl, String source, int type )
	{
	...
	public static boolean linkProgram( GL gl, GLProgram program, GLShader vertexShader, GLShader fragmentShader, String[] attributes )
	{
